...
sudo apt-fast --assume-yes --allow-unauthenticated --fix-broken install
sudo apt-fast --assume-yes --allow-unauthenticated upgrade
...
sudo apt-fast --assume-yes --allow-unauthenticated install python-software-properties
...
#sudo apt-fast update
#sudo apt-fast --assume-yes --allow-unauthenticated install git axel

echo -e '
=======================================
安裝Vim文字編輯器
======================================='
sudo apt-fast --assume-yes --allow-unauthenticated install vim

echo -e '
=======================================
安裝Aptitude、Synaptic軟體包裹管理程式
======================================='
sudo apt-fast --assume-yes --allow-unauthenticated install synaptic aptitude
...
======================================='
sudo apt-fast --assume-yes --allow-unauthenticated install ubuntu-restricted-extras
...
sudo apt-fast --assume-yes --allow-unauthenticated install pidgin
...
sudo apt-fast update
#Ubuntu/Debian users might want to install the dkms package to ensure that the VirtualBox host kernel modules (vboxdrv, vboxnetflt and vboxnetadp) are properly updated if the linux kernel version changes during the next apt-fast upgrade.
sudo apt-fast --assume-yes --allow-unauthenticated install dkms
sudo apt-fast --assume-yes --allow-unauthenticated install virtualbox-4.1
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install unity
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install boot-repair

echo -e "
=======================================
安裝K桌面環境(K Desktop Environment)軟體系列
======================================="
sudo apt-fast --assume-yes --allow-unauthenticated install kde-standard kdesudo kde-l10n-zhtw kdesdk-dolphin-plugins
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install gnome
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install burg
...
sudo add-apt-repository --yes ppa:git-core/ppa
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install git eclipse eclipse-cdt g++

echo -e '
=======================================
移除ibus輸入法
======================================='
sudo apt-fast --assume-yes purge ibus ibus-chewing
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install hime
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install vlc
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install libreoffice libreoffice-gnome libreoffice-kde
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install grub-customizer

echo -e '
=======================================
安裝make-kpkg
======================================='
sudo apt-fast --assume-yes --allow-unauthenticated install kernel-package fakeroot
...
sudo apt-fast update
sudo apt-fast --assume-yes --allow-unauthenticated install wine
...
移除不再需要的套件
======================================="
sudo apt-fast --assume-yes autoremove
...
　bleachbit
======================================='
sudo apt-fast --assume-yes --allow-unauthenticated install \
