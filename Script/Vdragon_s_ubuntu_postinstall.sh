...
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated --fix-broken install
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated upgrade
...
#sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install git axel
...
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install localepurge
...
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install python-software-properties
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install pidgin
...
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install dkms
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install virtualbox-4.1
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install boot-repair
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install gnome
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install google-chrome-stable
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install burg
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install git
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install hime
im-switch -s hime
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install vlc
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install libreoffice libreoffice-gnome libreoffice-kde
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install grub-customizer
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install wine
...
echo -e ${message_update_cache}
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install jdownloader
...
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install kde-standard kdesudo kde-l10n-zhtw kdesdk-dolphin-plugins gtk2-engines-oxygen gtk3-engines-oxygen
...
sudo ${option_sudo_prompt_password} apt-get update >> update_cache.log
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install multisystem
#SUDO_USER 是空的沒有用
...
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install dropbox
...
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install synaptic aptitude
...
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install ubuntu-restricted-extras

echo -e '
=======================================
安裝 Vim文字編輯器
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install vim

echo -e '
=======================================
安裝 htop系統資源監視程式
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install htop

echo -e '
=======================================
安裝 make-kpkg Linux作業系統核心軟體包裹製作工具
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install kernel-package fakeroot

echo -e '
=======================================
安裝 bleachbit檔案清理工具
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install bleachbit

echo -e '
=======================================
安裝 ppa-purge PPA還原程式
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install ppa-purge

echo -e '
=======================================
安裝 powertop電力消耗監視程式
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install powertop

echo -e '
=======================================
安裝 Eclipse整合式開發環境
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install eclipse

echo -e '
=======================================
安裝 Eclipse CDT Plugin
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install eclipse-cdt

echo -e '
=======================================
安裝 G++ C++toolchain
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install g++

echo -e '
=======================================
安裝 valgrind程式除錯工具
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install valgrind

echo -e '
=======================================
安裝 p7zip壓縮／封裝檔解壓縮程式以及RAR格式壓縮檔解壓縮支援
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install p7zip-full p7zip-rar

echo -e '
=======================================
安裝 K3b光碟燒錄程式
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install k3b

echo -e '
=======================================
安裝 deborphan孤立軟體包裹移除工具
======================================='
sudo ${option_sudo_prompt_password} apt-get --assume-yes --allow-unauthenticated install deborphan
