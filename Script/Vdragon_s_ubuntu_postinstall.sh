...
======================================="
echo -e ${message_add_software_source}
${command_gain_privilege} ${command_add_software_source} ppa:kubuntu-ppa/backports
echo -e ${message_update_cache}
${command_gain_privilege} ${command_update_source_cache} >> update_cache.log
...
echo -e "
=======================================
${message_install_or_update} CDRTools 光碟燒錄相關工具
======================================="
echo -e ${message_add_software_source}
${command_gain_privilege} ${command_add_software_source} ppa:brandonsnider/cdrtools
echo -e ${message_update_cache}
${command_gain_privilege} ${command_update_source_cache} >> update_cache.log
${command_gain_privilege} ${command_install_software} cdrtools
