...
${command_sudo_gain_privilege} gsettings set com.canonical.Unity.Panel systray-whitelist "['hime']"
${command_sudo_gain_privilege} glib-compile-schemas /usr/share/glib-2.0/schemas

echo -e '
=======================================
移除 ibus輸入法
======================================='
${command_sudo_gain_privilege} apt-get --assume-yes purge ibus ibus-chewing
...
======================================='
echo -e ${message_add_source}
${command_sudo_gain_privilege} apt-add-repository --yes 'deb http://liveusb.info/multisystem/depot all main'
